		...
		<section id="bo_w">
				...
				<div class="bo_w_tit write_div">
						...
						<div id="autosave_wrapper write_div mt10">
							<input type="text" name="wr_1" value="<?php echo $write['wr_1']?>"  required class="frm_input full_input required" size="50" maxlength="255" placeholder="일정 : 2020.04.04 ~ 2020.10.31">
						</div>


						<div id="autosave_wrapper write_div mt10">
							<input type="text" name="wr_2" value="<?php echo $write['wr_2']?>"  required class="frm_input full_input required" size="50" maxlength="255" placeholder="장소">
						</div>

						<div id="autosave_wrapper write_div mt10">
							<input type="text" name="wr_3" value="<?php echo $write['wr_3']?>"  required class="frm_input full_input required" size="50" maxlength="255" placeholder="일정링크">
						</div>

						<div id="autosave_wrapper write_div mt10">
							<input type="text" name="wr_4" value="<?php echo $write['wr_4']?>"  required class="frm_input full_input required" size="50" maxlength="255" placeholder="결과링크">
						</div>
