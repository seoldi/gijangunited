		...
		<div id="bo_list" style="width:<?php echo $width; ?>">
				...
				<div class="bo_list_head">
                	...
                	<b class="sound_only">현재 페이지 게시물  전체선택</b>
						...
						<span class="s-name">일정</span>
						<span class="s-user">리그명 </span>
						<span class="s-day">장소</span>
						<span class="s-link-1">일정</span>
						<span class="s-link-2">결과</span>
								</li>
						</ul>
				</div>
				<div class="bo_list">
						...
						<li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>"">
								...
								<span class="s-name"><?=$list[$i]['wr_1']?></span>
								<span class="s-user style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px" onclick="location.href='<?php echo $list[$i]['href'] ?>'">
										<div class="bo_tit">
										<?php
								...
								<span class="s-link s-link-1">
									<a href="<?=$list[$i]['wr_3']?>" target="blank"><i class="xi-external-link"></i></a>
								</span>

								<span class="s-link s-link-2">
									<a href="<?=$list[$i]['wr_4']?>" target="blank"><i class="xi-external-link"></i></a>
								</span>
