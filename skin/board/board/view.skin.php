	...
	<div class="r-sub-con">
		...
		<article id="bo_v" style="width:<?php echo $width; ?>">
			...
			<section id="bo_v_atc">
				...
				<script>
					$(document).ready(function() {
						...
						var fileSources = [<?php echo $view['wr_1'] ?>];
			...
			<?php if (array_filter($view['link'])) { ?>
				...
				<section id="bo_v_link">
					...
					<ul>
						...
						?>
								<li>
									<i class="xi-link" aria-hidden="true"></i> <a href="<?php echo $view['link_href'][$i] ?>" target="_blank">
			...
			<div id="bo_v_top">
				...
				<div class="btn_wrap">
					<ul class="bo_v_left">
						<?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn">수정</a></li><?php } ?>
						<?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn" onclick="del(this.href); return false;">삭제</a></li><?php } ?>
						...
						<?php if ($search_href) { ?><li><a href="<?php echo $search_href ?>" class="btn">검색</a></li><?php } ?>
					</ul>

					<ul class="bo_v_com">
						<li><a href="<?php echo $list_href ?>" class="btn">목록</a></li>
						<!-- <?php if ($reply_href) { ?><li><a href="<?php echo $reply_href ?>" class="btn">답변</a></li><?php } ?> -->
