		...
		<div id="bo_list" style="width:<?php echo $width; ?>">
				...
				<div class="bo_list">
						...
						<li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>"">
								...
								<?php if ($is_good) { ?><span class="w50"><nobr class="pc_none"><i class="fas fa-thumbs-up" aria-hidden="true"> </i></nobr> <?php echo $list[$i]['wr_good'] ?></span><?php } ?>
								<?php if ($is_nogood) { ?><span class="w50"><nobr class="pc_none"><i class="fas fa-thumbs-down" aria-hidden="true"> </i></nobr> <?php echo $list[$i]['wr_nogood'] ?></span><?php } ?>
								<span class="s-day"><nobr class="pc_none"></nobr> <?php echo $list[$i]['datetime'] ?></span>
								<span class="s-data">
									<?php
										if (isset($list[$i]['icon_file'])) echo rtrim($list[$i]['icon_file']);
										if($list[$i]['wr_1']) { echo '<i class="fas fa-download" aria-hidden="true"></i>'; }
									?>
								</span>
						</li>
						<?php } ?>
