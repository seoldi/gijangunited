                        ...
                        <div class="gall_con">
                                ...
                                <a href="<?php echo $list[$i]['href'] ?>">
                                    ...
                                    <?php } else {
                                        ...
                                        if ($thumb['src']) {
                                            ...
                                            $img_content = '<img src="http://seoulfa.dothome.co.kr/data/file/gallery/thumb/' . $list[$i]['wr_1'] . '">';
                                        } else {
                            ...
                            <div class="gall_text_href">
                                ...
                                <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
                                    ...
                                    <?php echo utf8_strcut(strip_tags($list[$i]['subject']), 50, '..'); ?>
                                    <?php
                                ...
                                <span class="gall_date"><span class="tl">작성일 </span><i class="fas fa-clock" aria-hidden="true"></i> <?php echo $list[$i]['datetime'] ?></span>
                            </div>


                            <div class="gall_info">
                                <span class="sound_only">작성자 </span><?php echo $list[$i]['name'] ?>
                                <span class="gall_date"><span class="sound_only">작성일 </span><i class="fas fa-clock" aria-hidden="true"></i> <?php echo $list[$i]['datetime2'] ?></span>
                                <span class="gall_view"><span class="sound_only">조회 </span><i class="fas fa-eye" aria-hidden="true"></i> <?php echo $list[$i]['wr_hit'] ?></span>
                            </div>
                            <div class="gall_option">
                                <?php if ($is_good) { ?><span class="sound_only">추천</span><strong><i class="fas fa-thumbs-o-up" aria-hidden="true"></i> <?php echo $list[$i]['wr_good'] ?></strong><?php } ?>
                                <?php if ($is_nogood) { ?><span class="sound_only">비추천</span><strong><i class="fas fa-thumbs-o-down" aria-hidden="true"></i> <?php echo $list[$i]['wr_nogood'] ?></strong><?php } ?>
                            </div>
                        </div>
                    </div>
                </li>
        ...
        <?php if ($list_href || $is_checkbox || $write_href) { ?>
            <div class="bo_fx" style="float:right;">
                ...
                <ul class="btn_bo_user" style="display: flex; width: 100%;">
                    ...
                    <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn btn_dark">글쓰기</a></li><?php } ?>
                </ul>
            </div>
        <?php } ?>
    </form>
