                ...
                <div class="wr_box">
                    ...
                    <div class="bo_w_tit write_div">
                        ...
                        <div id="autosave_wrapper" class="write_div">
                            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="후원사 업체명">
                ...
                <div class="wr_box">
                    ...
                    <?php for ($i = 1; $is_link && $i <= 1; $i++) { ?>
                        <div class="bo_w_link write_div">
                            ...
                            <input type="text" name="wr_link<?php echo $i ?>" value="<?php if ($w == "u") {echo $write['wr_link' . $i];} ?>" id="wr_link<?php echo $i ?>" class="frm_input full_input" size="50"  placeholder="hhtp:// 로 시작하는 url">
                        </div>
                    <?php } ?>
                </div>
            </div>
