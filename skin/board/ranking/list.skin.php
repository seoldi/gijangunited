			...
			<form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
				...
				<div class="bo_list head">
					<ul>
						<li>
							...
							<?php } ?>
							<span class="ranking">순위</span>
							<span class="name">팀명</span>
							<span class="score">승점</span>
							<span class="score">승</span>
							<span class="score">무</span>
							<span class="score">패</span>
							<span class="score">골득실</span>
							<span class="score">경기수</span>
				...
				<div class="bo_list list">
					<ul>
						...
						?>
							...
							<span class="name">
								<img src="<?php echo G5_THEME_IMG_URL ?>/game/<?php echo getTeamClass($list[$i]['wr_1']); ?>.svg">
								<p><?php echo $list[$i]['wr_1'] ?></p>
							</span>
							<span class="score"><?php echo $list[$i]['wr_2'] ?></span> <!-- 승점 -->
							<span class="score"><?php echo $list[$i]['wr_3'] ?></span> <!-- 승 -->
							<span class="score"><?php echo $list[$i]['wr_4'] ?></span> <!-- 무 -->
							<span class="score"><?php echo $list[$i]['wr_5'] ?></span> <!-- 패 -->
							<span class="score"><?php echo $list[$i]['wr_6'] ?></span> <!-- 골득실 -->
							<span class="score"><?php echo $list[$i]['wr_7'] ?></span> <!-- 경기수 -->
							<span class="score" style="display: none;"><?php echo $list[$i]['wr_10'] ?></span> <!-- 승점 + 골득실 -->
							<span class="icon">
				...
				<div class="bo_fx">
					...
					<ul class="btn_bo_user" style="display: flex; width: 100%;">
						...
						<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn btn_dark">순위추가</a></li><?php } ?>
					</ul>
				</div>
